...
chỉ còn \emph{mặt cầu} $|y-x_0|=ct$ (bán kính $ct$, vận tốc $c$), không phải toàn bộ quả cầu.
\end{dieukienbox}

\begin{nhobox}
\textbf{Nguyên lý Huygens mạnh} ($n=3$, vận tốc $c$):
\[
  u(x_0,t) \text{ chỉ phụ thuộc } g,h \text{ trên mặt cầu } |y-x_0|=ct.
\]
Hệ quả trực tiếp: nếu mặt cầu $\partial B_{ct}(x_0)$ không cắt $\operatorname{supp}(g)\cup\operatorname{supp}(h)$
thì $u(x_0,t)=0$.
